...
The output noise, at a specified output node, is the root mean square sum of the noise generated by all the resistors and semiconductors in the circuit. The avove waveform shows the output noise of the multiplier circuit.
