 ...
 * [Netlist ](https://github.com/AMITS424/Four-quadrant-analog-multiplier/blob/main/README.md#:~:text=the%20multiplier%20circuit.-,Netlist,-The%20netlist%20for)
 * [Simulation result for neuron activation function](https://github.com/AMITS424/Four-quadrant-analog-multiplier/blob/main/README.md#:~:text=function%20is%20Netlist-,Simulation%20result%20for%20neuron%20activation%20function,-Activation%20function%20decides)
 * [Results and Analysis](https://github.com/AMITS424/Four-quadrant-analog-multiplier/blob/main/README.md#:~:text=Tangent%20Hyperbolic%20function.-,Results%20and%20Analysis,-Two%20sinusoidal%20waves)
...
The input-referred noise indicates how much the input signal is corrupted by the circuit’s noise, i.e., how small an input the circuit can detect with acceptable SNR. The above waveforms shows the input noise for both input sinusoidal signals applied to the multiplier circuit.
...
The output noise, at a specified output node, is the root mean square sum of the noise generated by all the resistors and semiconductors in the circuit. The above waveform shows the output noise of the multiplier circuit.
...
## Author 
[Amit Sarkar](https://github.com/AMITS424),MSR(EE) IIT Delhi 
